...
SECRET_KEY = 'django-insecure-=&we*c0s#j!-20ds4@#7n-a()%e#o@*p3dws0oh21ogygjv2d('
...
INSTALLED_APPS = [
    'travello.apps.TravelloConfig',     #para que el proyecto sepa con que aplicaciones esta trabajando
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': '12345',
        'HOST': 'localhost',    #especificamos el host
    }
}
